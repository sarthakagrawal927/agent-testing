...
The public, agent-first summary is served by Cloudflare Workers Static Assets
from `site/`. Use `npm run site:dev` for a local preview and `npm run deploy`
for the configured `map-of-agent-testing` Worker.
